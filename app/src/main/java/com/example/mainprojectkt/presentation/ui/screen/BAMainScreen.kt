                ...
                if (user != null) {
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Text(
                                text = "Все ваши книги и прогресс чтения в одном месте",
                    ...
                    Text(
                        text = "Чтобы получить доступ к своим книгам и заметкам, пожалуйста, авторизуйтесь в системе.",
                        style = MaterialTheme.typography.bodyLarge,
                        color = MaterialTheme.colorScheme.onSurfaceVariant,
                        textAlign = TextAlign.Center,
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Text(
                                text = "Нажмите на кнопку меню слева ☰",
                                style = MaterialTheme.typography.bodyLarge,
